...
function createDatabaseUrl() {
	...
	// const host = process.env.DB_HOST ?? "dpg-cg69sql269v5l65a5leg-a.oregon-postgres.render.com";
	// const name = process.env.DB_NAME ?? "ourdatabase_ten6";
	// const password = process.env.DB_PASS ?? process.env.DB_PASSWORD ?? "AYGKlNp47Q0YEkMzjVe2xFRAk7YeHK7T";
	// const port = process.env.DB_PORT ?? "5432";
	// const username =
	// 	process.env.DB_USER ?? process.env.DB_USERNAME ?? "anoshmalik";
